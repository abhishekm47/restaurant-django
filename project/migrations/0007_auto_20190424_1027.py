# Generated by Django 2.0 on 2019-04-24 04:57
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('project', '0006_auto_20190424_1008'),
    ]
    ...
    operations = [
        migrations.AddField(
            model_name='menuitem',
            name='category',
            field=models.CharField(choices=[('breakfast', 'breakfast'), ('lunch', 'lunch'), ('dinner', 'dinner'), ('coffee', 'coffee'), ('snacks', 'snacks')], default='available', max_length=20),
        ),
        migrations.AlterField(
            model_name='menuitem',
            name='cost',
            field=djmoney.models.fields.MoneyField(decimal_places=2, default=Decimal('0.0'), default_currency='EUR', max_digits=50),
        ),
        migrations.AlterField(
            model_name='menuitem',
            name='cost_currency',
        ...
        migrations.AlterField(
            model_name='menuitem',
            name='time',
            field=models.TimeField(default=datetime.datetime(2019, 4, 24, 4, 57, 15, 477381)),
        ),
    ]
